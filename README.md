...
- Mobile: +91 8756559190, +91 9140110308
- LinkedIn: www.linkedin.com/in/sunilkrgautam98

---

## 🔎 Research Interests
- Wireless Power Transfer for Electric Vehicle and Aircraft Applications
- Resonant Converter Design
- Solar-PV-Grid Integration
- High-Frequency Power Conversion Topology Design and Analysis
- SiC and Wide Bandgap Devices
- Magnetics Design and EMI/EMC Consideration

## 🛠 Technical Skills

### ⚡ Power Electronics
- DC-DC, DC-AC, AC-DC, AC-AC Conveters
- Isolated and Resonant Converters
- Wireless Power Transfer Systems
- Power Factor Correction Circuits
- Converter Control Design
- Soft-Switching Techniques
- High-voltage and High-Current Bus-Bar Design
- High Speed Gate Driver Design - Signle Channel and Dual Channel with Boot-strap Circuit
- Sensing and Protection Circuit Design
- Magnetics Design
- Converter Thermal Designing 

### 🔧 Hardware & Embedded
- Altium PCB Design
- TI DSP Control Implementation - F28379D, F280049C, F28335
- TI Code Composer Studio (CCS)
- Analog Control Implementaion
- dSpace-HIL
- Hardware Testing and Debugging - Singnal to High Power Level 
...
- ANSYS Maxwell
- AutoCad
- Overleaf and Latex Technical Documantation
- Microsoft Word, Visio, Excell and Power Point Presentation
---
### 📚 Subject Understanding
- Power Electronics
- Circuit Analysis
- Control Syatem Design and Analysis
...
## 📄 Publications
### Patents
1.	Multi-compatible wireless charging solutions for electric vehicles application and a method thereof. (India Patent-562135) 
2.	Compact single-stage wireless charging system for EVs application and a method thereof. (India Patent-Submitted)
### Journals
1.	S.K. Gautam and M. Das, “Single-Stage Wireless Charging System for EVs with PFC and Buck Operation,” in IEEE Transaction on Industrial Electronics. (Accepted-In Press)
2.	S.K. Gautam and M. Das, “Multi-compatible Wireless Charging System for EVs with a Wide Battery Voltage Range of 72-400 V,” in IEEE Transaction on Industrial Electronics. (Under review)
3.	S.K. Gautam and M. Das, “Multi-compatible Wireless Charging System with a Reconfigurable Transmitting Coil for EVs,” in IEEE Transaction on Power Electronics. (Under review)
4.	S.K. Gautam and R. Kumar, “Synchronization of Solar PV-Wind-Battery-Based Water Pumping System using Brushless DC Motor Drive”, International Journal of Power Electronics, Vol.18 No.4, pp.435 – 459, Oct 2023.
### Conferences
1.	S.K. Gautam and M. Das, “Wireless Charging System for Electric Vehicles with Reconfigurable Coil and Output Voltage”, in 2026 IEEE Energy Conversion Congress and Expo Europe (ECCE Europe), Valencia, Spain (Submitted)
2.	S.K. Gautam and M. Das, “Single-Stage Solar PV Wireless Charging System for Electric Vehicles Ultra-Wide Voltage Applications,” 2025 IEEE Energy Conversion Congress and Expo Asia (ECCE Asia), Bengaluru, India, 2025, pp. 1-6.
3.	S. K. Gautam and M. Das, “Anti-Resonant Tank-based Wireless Charging of EVs for Ultra-Wide Output Voltage Applications,” 2024 IEEE International Conference on Power Electronics, Drives and Energy Systems (PEDES), Mangalore, India, 2024, pp. 1-6. 
4.	S. K. Gautam, M. Das and R. M. Reddy, “Double-Sided LC with LCC Anti-Resonant Tank-Based WPT System for Wide Output Voltage Range,” IECON 2023- 49th Annual Conference of the IEEE Industrial Electronics Society, Singapore, Singapore, 2023, pp. 1-6.
---
